...
const russianPresetNotes = {
  ...
  yandex_music: "\u0420\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u043e\u0432\u0430\u043d\u043d\u044b\u0439 \u0431\u0435\u0437\u043e\u043f\u0430\u0441\u043d\u044b\u0439 \u044d\u043a\u0441\u043f\u043e\u0440\u0442 \u0434\u043b\u044f \u0441\u0442\u0440\u0438\u043c\u0438\u043d\u0433\u0430.",
  vk_music: "\u0420\u0435\u043a\u043e\u043c\u0435\u043d\u0434\u043e\u0432\u0430\u043d\u043d\u044b\u0439 \u0431\u0435\u0437\u043e\u043f\u0430\u0441\u043d\u044b\u0439 \u044d\u043a\u0441\u043f\u043e\u0440\u0442 \u0434\u043b\u044f \u0441\u0442\u0440\u0438\u043c\u0438\u043d\u0433\u0430.",
  custom_safe: "\u0414\u043e\u043f\u043e\u043b\u043d\u0438\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u0437\u0430\u043f\u0430\u0441 True Peak \u0434\u043b\u044f \u0441\u0436\u0430\u0442\u044b\u0445 \u0444\u043e\u0440\u043c\u0430\u0442\u043e\u0432.",
};

const russianPresetLabels = {
...
function renderPresets() {
  ...
  for (const preset of state.presets) {
    ...
    button.innerHTML = `
      <h3>${russianPresetLabels[preset.id] || preset.label}</h3>
      <div class="target">${preset.targetI} LUFS / ${preset.truePeak} dBTP</div>
      <p>${russianPresetNotes[preset.id] || preset.notes}</p>
    `;
